...
Route::post('/comment', 'HomeController@comment', 'home.comment');
...
Route::put('/admin/post/statusChange/{id}', 'Admin\PostController@statusChange', 'admin.post.statusChange');
...
Route::put('/admin/slide/statusChange/{id}', 'Admin\SlideController@statusChange', 'admin.slide.statusChange');
